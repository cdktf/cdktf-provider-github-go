...
func (r *jsiiProxy_RepositoryRulesetRulesTagNamePatternOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RepositoryRulesetRulesTagNamePatternOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
