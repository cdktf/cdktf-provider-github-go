...
func (r *jsiiProxy_RepositoryRulesetRulesCommitAuthorEmailPatternOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RepositoryRulesetRulesCommitAuthorEmailPatternOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
