...
type RepositoryRulesetConditionsRefName struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.36.0/docs/resources/repository_ruleset#exclude RepositoryRuleset#exclude}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.36.0/docs/resources/repository_ruleset#include RepositoryRuleset#include}
