...
type RepositoryRulesetConditionsRefName struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.1/docs/resources/repository_ruleset#exclude RepositoryRuleset#exclude}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.2.1/docs/resources/repository_ruleset#include RepositoryRuleset#include}
