...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RepositoryTagProtection)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "tagProtectionId", GoGetter: "TagProtectionId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RepositoryTagProtectionConfig)(nil)).Elem(),
	)
}
