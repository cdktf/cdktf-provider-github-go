...
func (b *jsiiProxy_BranchProtectionRestrictPushesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BranchProtectionRestrictPushesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
