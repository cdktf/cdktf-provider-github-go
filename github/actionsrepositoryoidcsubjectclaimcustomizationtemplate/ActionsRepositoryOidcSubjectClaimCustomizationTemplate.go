...
import (
	...
	"github.com/cdktf/cdktf-provider-github-go/github/v7/actionsrepositoryoidcsubjectclaimcustomizationtemplate/internal"
...
func (j *jsiiProxy_ActionsRepositoryOidcSubjectClaimCustomizationTemplate) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ActionsRepositoryOidcSubjectClaimCustomizationTemplate)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
