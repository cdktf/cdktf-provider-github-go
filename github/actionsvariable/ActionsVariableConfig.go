...
type ActionsVariableConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.39.0/docs/resources/actions_variable#repository ActionsVariable#repository}
