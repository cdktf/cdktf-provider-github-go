...
import (
	...
	"github.com/hashicorp/cdktf-provider-github-go/github/v3/datagithubteam/internal"
...
func (j *jsiiProxy_DataGithubTeam) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataGithubTeam)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
