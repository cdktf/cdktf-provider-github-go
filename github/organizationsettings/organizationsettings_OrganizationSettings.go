...
import (
	...
	"github.com/cdktf/cdktf-provider-github-go/github/v5/organizationsettings/internal"
...
func (j *jsiiProxy_OrganizationSettings) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_OrganizationSettings)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
