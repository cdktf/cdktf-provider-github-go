...
type RepositoryConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.44.0/docs/resources/repository#allow_squash_merge Repository#allow_squash_merge}
