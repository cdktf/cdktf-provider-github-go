...
type RepositorySecurityAndAnalysis struct {
	...
	AdvancedSecurity *RepositorySecurityAndAnalysisAdvancedSecurity `field:"required" json:"advancedSecurity" yaml:"advancedSecurity"`
	...
	SecretScanning *RepositorySecurityAndAnalysisSecretScanning `field:"required" json:"secretScanning" yaml:"secretScanning"`
	...
	SecretScanningPushProtection *RepositorySecurityAndAnalysisSecretScanningPushProtection `field:"required" json:"secretScanningPushProtection" yaml:"secretScanningPushProtection"`
}
