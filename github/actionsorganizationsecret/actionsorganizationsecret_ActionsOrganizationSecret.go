...
import (
	...
	"github.com/hashicorp/cdktf-provider-github-go/github/v3/actionsorganizationsecret/internal"
...
func (j *jsiiProxy_ActionsOrganizationSecret) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ActionsOrganizationSecret)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
