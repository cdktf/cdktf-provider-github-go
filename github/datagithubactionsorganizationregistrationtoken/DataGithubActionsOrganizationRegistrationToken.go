...
import (
	...
	"github.com/cdktf/cdktf-provider-github-go/github/v7/datagithubactionsorganizationregistrationtoken/internal"
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataGithubActionsOrganizationRegistrationToken)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
